...
def return_artist_dataframe(): 
    ...
    r = requests.get("https://api.spotify.com/v1/playlists/6SFx39GsC05tDIFlTMUsIK", headers = input_variables)
    
    data_globaltop50 = r.json()
    print(data_globaltop50)
    ...
    artist_id_url = "https://open.spotify.com/artist/3TVXtAsR1Inumwj472S9r4?si=plTEFspHRaCObl1SKzEtBg"
    count=0
...
test_df = return_artist_dataframe()
